                        ...
                        render={({ field }) => (
                            ...
                            <FormControl>
                                <div className="relative">
                                    ...
                                    <Input type="number" placeholder="0" className="pr-8" value={field.value?.toString() || ''} onChange={e => field.onChange(parseFloat(e.target.value) || 0)} />
                                </div>
                            </FormControl>
                            <FormMessage />
                            </FormItem>
